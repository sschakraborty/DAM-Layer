...
public class ConfigurationBuilderImpl implements ConfigurationBuilder {
    ...
    private Properties buildProperties(ConnectorMetadata metadata) {
        ...
        properties.put("hibernate.connection.autocommit", metadata.isAutoCommit());
        properties.put("hibernate.show_sql", metadata.isDebugMode());
        ...
        properties.put("hibernate.hikari.maximumPoolSize", metadata.getMaxPoolSize());
        properties.put("hibernate.hikari.idleTimeout", metadata.getIdleTimeout());
        properties.put("hibernate.hikari.connectionTimeout", metadata.getConnectionTimeout());
